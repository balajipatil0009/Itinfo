    ...
    <>
      ...
      <div className="flex justify-center">
        <div className="w-[80vw]">
          ...
          <h3 className=" text-xl font-sansMedium m-4"> Who we are: </h3>
          <p>
          ...
          <h3 className=" text-xl font-sansMedium m-4"> History:</h3>
          <p>
          ...
          <h3 className=" text-xl font-sansMedium m-4">Growth & Expansion: </h3>
          <p>
          ...
          <h3 className=" text-xl font-sansMedium m-4">
            {" "}
          ...
          <h3 className=" text-xl font-sansMedium m-4"> Looking Ahead:</h3>
          <p>
